...
export function createParticleReveal(
  ...
  let pointerReveal = hoverQuery.matches;
  const isCrisp = () => reducedMotion || !htmlInCanvas || !pointerReveal;
  ...
  function render() {
    ...
    gl!.uniform1f(uniforms.uCrisp, isCrisp() ? 1 : 0);
  ...
  function onHoverChange() {
    pointerReveal = hoverQuery.matches;
    start();
  }
